...
bool equal( vector &vector1, std::vector< int > &vector2 )
{
    ...
    {
        cout << "capacity difference" << endl;
        cout << "vector1: size = " << vector1.size() << ", capacity = " << vector1.capacity() << endl;
        cout << "vector2: size = " << vector2.size() << ", capacity = " << vector2.capacity() << std::endl;
        return false;
    }
   if( vector2.capacity() == 0 )
   {
      ...
      if( *first1 != *first2 )
      {
          cout << "myfirst difference" << endl;
          return false;
      }

      if( *last1 != *last2 )
      {
          cout << "mylast difference" << endl;
          return false;
      }
      if( *end1 != *end2 )
      {
          cout << "myend difference" << endl;
          return false;
      }
   }
